...
_See code: [dist/commands/config.ts](https://github.com/fumeapp/fume-cli/blob/v2.1.0/dist/commands/config.ts)_
...
_See code: [dist/commands/deploy.ts](https://github.com/fumeapp/fume-cli/blob/v2.1.0/dist/commands/deploy.ts)_
