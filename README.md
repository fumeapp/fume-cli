...
running command...
$ fume (--version)
fume-cli/0.2.9 darwin-arm64 node-v16.16.0
$ fume --help [COMMAND]
USAGE
  $ fume COMMAND
...
...
_See code: [dist/commands/auth/login.ts](https://github.com/fumeapp/fume-cli/blob/v0.2.9/dist/commands/auth/login.ts)_
...
_See code: [dist/commands/auth/logout.ts](https://github.com/fumeapp/fume-cli/blob/v0.2.9/dist/commands/auth/logout.ts)_
...
_See code: [dist/commands/auth/status.ts](https://github.com/fumeapp/fume-cli/blob/v0.2.9/dist/commands/auth/status.ts)_
...
_See code: [dist/commands/config.ts](https://github.com/fumeapp/fume-cli/blob/v0.2.9/dist/commands/config.ts)_
...
_See code: [dist/commands/deploy.ts](https://github.com/fumeapp/fume-cli/blob/v0.2.9/dist/commands/deploy.ts)_
