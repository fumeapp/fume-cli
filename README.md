...
fume-cli/0.1.17 darwin-x64 node-v14.17.0
$ fume --help [COMMAND]
USAGE
  $ fume COMMAND
...
...
_See code: [src/commands/auth/login.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.17/src/commands/auth/login.ts)_
...
_See code: [src/commands/auth/logout.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.17/src/commands/auth/logout.ts)_
...
_See code: [src/commands/auth/status.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.17/src/commands/auth/status.ts)_
...
_See code: [src/commands/config.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.17/src/commands/config.ts)_
...
_See code: [src/commands/deploy.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.17/src/commands/deploy.ts)_
...
_See code: [src/commands/purge.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.17/src/commands/purge.ts)_
<!-- commandsstop -->
