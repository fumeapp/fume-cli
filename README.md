...
fume-cli/0.1.23 darwin-x64 node-v14.15.3
$ fume --help [COMMAND]
USAGE
  $ fume COMMAND
...
...
_See code: [src/commands/auth/login.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.23/src/commands/auth/login.ts)_
...
_See code: [src/commands/auth/logout.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.23/src/commands/auth/logout.ts)_
...
_See code: [src/commands/auth/status.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.23/src/commands/auth/status.ts)_
...
_See code: [src/commands/config.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.23/src/commands/config.ts)_
...
_See code: [src/commands/deploy.ts](https://github.com/fumeapp/fume-cli/blob/v0.1.23/src/commands/deploy.ts)_
