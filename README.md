...
fume-cli/0.0.19 darwin-x64 node-v12.18.0
$ fume --help [COMMAND]
USAGE
  $ fume COMMAND
...
...
_See code: [src/commands/auth/login.ts](https://github.com/fumeapp/fume-cli/blob/v0.0.19/src/commands/auth/login.ts)_
...
_See code: [src/commands/auth/logout.ts](https://github.com/fumeapp/fume-cli/blob/v0.0.19/src/commands/auth/logout.ts)_
...
_See code: [src/commands/auth/status.ts](https://github.com/fumeapp/fume-cli/blob/v0.0.19/src/commands/auth/status.ts)_
...
_See code: [src/commands/config.ts](https://github.com/fumeapp/fume-cli/blob/v0.0.19/src/commands/config.ts)_
...
_See code: [src/commands/deploy.ts](https://github.com/fumeapp/fume-cli/blob/v0.0.19/src/commands/deploy.ts)_
...
_See code: [src/commands/purge.ts](https://github.com/fumeapp/fume-cli/blob/v0.0.19/src/commands/purge.ts)_
<!-- commandsstop -->
