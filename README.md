...
running command...
$ fume (--version)
fume-cli/2.0.0 darwin-arm64 node-v18.15.0
$ fume --help [COMMAND]
USAGE
  $ fume COMMAND
...
...
_See code: [dist/commands/config.ts](https://github.com/fumeapp/fume-cli/blob/v2.0.0/dist/commands/config.ts)_
...
_See code: [dist/commands/deploy.ts](https://github.com/fumeapp/fume-cli/blob/v2.0.0/dist/commands/deploy.ts)_
